<template>
    <jet-action-section>
        <template #title>
            <h3 style="font-size: 1.5rem;line-height: 1.5;font-weight: bold;">Sesiones del navegador</h3>
        </template>

        <template #description>
            <p style="font-size:15px">Administre y cierre la sesión de sus sesiones activas en otros navegadores y dispositivos.</p>
        </template>

        <template #content>
            <div class="max-w-xl text-sm text-gray-600">
                
                <p style="font-size:15px">Si es necesario, puede cerrar la sesión de todas las demás sesiones de su navegador en todos sus dispositivos. Algunas de sus sesiones recientes se enumeran a continuación; sin embargo, es posible que esta lista no sea exhaustiva. Si cree que su cuenta se ha visto comprometida, también debe actualizar su contraseña.</p> 
            </div>
            ...
            <div class="flex items-center mt-5">
                <jet-danger-button @click="confirmLogout" style="font-size:15px">
            ...
            <jet-dialog-modal :show="confirmingLogout" @close="closeModal">
                ...
                <template #footer>
                    ...
                    <jet-button style="font-size:15px" class="ml-2" @click="logoutOtherBrowserSessions" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                        Cerrar sesión en otras sesiones del navegador
                    </jet-button>
                </template>
            </jet-dialog-modal>
