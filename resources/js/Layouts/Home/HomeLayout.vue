<template>
  <div>
    ...
    >
      ...
      >
        <img alt="Logo" src="/img/logo1.png" class="logo-default max-h-40px" />
      </jet-nav-link>
    ...
    <!--end::Header Mobile-->
    <div class="d-flex flex-column flex-root min-h-screen">
      <!--begin::Page-->
              ...
              <ul class="nav flex-column" role="tablist">
                ...
                >
                  <a
                    ...
                    href="#"
                    class="nav-link btn btn-icon btn-clean btn-lg {{ routeIs('dashboard') ? 'active' : '' }}"
                    data-toggle="tab"
                ...
                >
                  ...
                  id="tablero"
                    href="#"
                    class="nav-link btn btn-icon btn-clean btn-lg {{ isRoute('/cuentas') ? 'active' : '' }}"
                    data-toggle="tab"
          ...
          >
            ...
            <div class="aside-workspace scroll scroll-push my-2">
              ...
              <div class="tab-content">
                <!--begin::Tab Pane-->
                <div
                  class="tab-pane p-3 px-lg-7 py-lg-5 fade"
                  id="kt_aside_tab_1"
                >
                  <center>
                    <h3
                      class="p-2 p-lg-3 my-1 my-lg-3"
                      style="
                        font-size: 1.5rem;
                        font-weight: bold;
                        line-height: 1.2;
                  ...
                  <span
                    class="text-muted font-weight-bold mt-2"
                    id="fecha"
                  ...
                  >
                    <h1
                      ...
                      "
                    >
                      <p id="dia" style="font-size: 2rem;margin-bottom: 0.5rem;font-weight: bold;line-height: 1.2;"></p>
                    </h1>
                    <p id="mesAno" style="font-size: 1rem;font-weight: bold;"></p> </span
                  >&nbsp;
                </div>
                <!--end::Tab Pane-->
                <!--begin::Tab Pane-->
                <div class="tab-pane fade" id="kt_aside_tab_2">
                  <!--begin::Aside Menu-->
                  <div
                    class="aside-menu-wrapper flex-column-fluid px-3 px-lg-10 py-5"
                  ...
                  >
                    ...
                    >
                      ...
                      <ul class="menu-nav">
                        ...
                        <li id="cuenta" class="menu-item" aria-haspopup="true">
                          <inertia-link
                            id="cuentas"
                            :key="cuentas"
                            :href="route('cuentas.index')"
                            class="menu-link"
                            :active="route().current('cuentas.index')"
                          >
                            ...
                            <span class="menu-text" style="font-size: 12px"
                              >Cuentas</span
                            >
                          </inertia-link>
                        </li>
                ...
                <div class="tab-pane fade" id="kt_aside_tab_3">
                  ...
                  >
                    ...
                    >
                      ...
                      <ul class="menu-nav">
                        <li class="menu-section">
                          <h4 class="menu-text">Inteligencia</h4>
                          <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        ...
                        <li id="graf" class="menu-item" aria-haspopup="true">
                          <inertia-link
                          id="graficos"
                            :href="route('graficos.index')"
                            class="menu-link"
                        ...
                        <li class="menu-item" aria-haspopup="true">
                          <a
                            href="javascript:en_construccion();"
                            class="menu-link"
                          >
                            <span class="svg-icon menu-icon">
                              <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Library.svg-->
                ...
                <!--begin::Tab Pane-->
                <div class="tab-pane fade" id="kt_aside_tab_4">
                  <!--begin::Aside Menu-->
                  <div
                    class="aside-menu-wrapper flex-column-fluid px-3 px-lg-10 py-5"
                    id="kt_aside_menu_wrapper"
                  >
                    ...
                    >
                      ...
                      <ul class="menu-nav">
                        ...
                        <li id="client" class="menu-item" aria-haspopup="true">
                          <inertia-link
                        ...
                        <li id="dispo" class="menu-item" aria-haspopup="true">
                          <inertia-link
                          id="dispositivos"
                            :key="dispositivos"
                            :href="route('dispositivos.index')"
                            class="menu-link"
                            :active="route().current('dispositivos.index')"
                          >
                            <span class="svg-icon menu-icon">
                              <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Library.svg-->
                              <svg
                        ...
                        <li id="medicion" class="menu-item" aria-haspopup="true">
                          <inertia-link
                            id="mediciones"
                            :key="mediciones"
                            :href="route('mediciones.index')"
                            class="menu-link"
                            :active="route().current('mediciones.index')"
                          >
                            <span class="svg-icon menu-icon">
                              <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Library.svg-->
                              <svg
                ...
                <!--begin::Tab Pane-->
                <div class="tab-pane fade" id="kt_aside_tab_5">
                  <!--begin::Aside Menu-->
                  <div
                    class="aside-menu-wrapper flex-column-fluid px-3 px-lg-10 py-5"
                    id="kt_aside_menu_wrapper"
                  >
                    ...
                    >
                      ...
                      <ul class="menu-nav">
                        <li class="menu-section">
                          <h4 class="menu-text">Listas</h4>
                          <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                        </li>
                        <li class="menu-item" aria-haspopup="true">
                          <a href="lista_general.php" class="menu-link">
                            <span class="svg-icon menu-icon">
                              <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Library.svg-->
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="menu-item" aria-haspopup="true">
                          <a href="lista_cliente.php" class="menu-link">
                            <span class="svg-icon menu-icon">
                              <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Library.svg-->
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                        ...
                        <li class="menu-item" aria-haspopup="true">
                          <a href="lista_dispositivos.php" class="menu-link">
                            <span class="svg-icon menu-icon">
                              <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Library.svg-->
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
                            ...
                            <span class="menu-text" style="font-size: 12px"
                              >Lista Dispositivo</span
                            >
                          </a>
                        </li>
                        <li class="menu-item" aria-haspopup="true">
                          <a href="lista_mediciones.php" class="menu-link">
                            <span class="svg-icon menu-icon">
                              <!--begin::Svg Icon | path:/metronic/theme/html/demo1/dist/assets/media/svg/icons/Home/Library.svg-->
                              <svg
                                xmlns="http://www.w3.org/2000/svg"
    ...
    <div id="kt_quick_user" class="offcanvas offcanvas-left p-10">
      ...
      >
        <h3
          ...
          style="font-weight: bold !important; font-size: 1.5rem"
        >
          Perfil de usuario
        </h3>
        <button
        ...
        <div class="d-flex align-items-center mt-5">
          ...
          <div class="d-flex flex-column">
            <a
              ...
              style="font-weight: bold !important; font-size: 1.5rem !important"
            >
              {{ $page.props.user.name }} {{ $page.props.user.lastname }}</a
            >
          ...
          <div class="navi-item">
            <jet-dropdown-link :href="route('profile.show')">
              <div class="navi-link">
                ...
                <div class="navi-text" style="font-size: 12px">
                  <div
                    class="font-weight-bold"
                    style="font-weight: bold !important; font-size: 13px"
                  >
                    Mi Perfil
                  </div>
                  <div class="text-muted">Modificar mis datos aqui</div>
                </div>
              </div>
            </jet-dropdown-link>
          </div>
        ...
        <div style="display: none">
          ...
          >
            <span class="svg-icon svg-icon-success mr-5">
              <span class="svg-icon svg-icon-lg">
                <!--begin::Svg Icon | path:/metronic/theme/html/demo3/dist/assets/media/svg/icons/Communication/Write.svg-->
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  width="24px"
          ...
          <div class="d-flex align-items-center bg-light-info rounded p-5">
            <span class="svg-icon svg-icon-info mr-5">
              <span class="svg-icon svg-icon-lg">
                <!--begin::Svg Icon | path:/metronic/theme/html/demo3/dist/assets/media/svg/icons/General/Attachment2.svg-->
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  width="24px"
                  ...
                  <div class="d-flex flex-column mb-5 align-items-start">
                    <div class="d-flex align-items-center">
                      <div class="symbol symbol-circle symbol-40 mr-3">
                        <img
                          alt="Pic"
                          src="https://keenthemes.com/metronic/theme/html/demo3/dist/assets/media/users/300_12.jpg"
                        />
                      </div>
                      <div>
                        <a
                  ...
                  <div class="d-flex flex-column mb-5 align-items-end">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="symbol symbol-circle symbol-40 ml-3">
                        <img
                          alt="Pic"
                          src="https://keenthemes.com/metronic/theme/html/demo3/dist/assets/media/users/300_21.jpg"
                        />
                      </div>
                    </div>
                    <div
...
export default {
  mounted(){
    ...
    $("#kt_quick_user_toggle").click(function(params) {
        $("#kt_quick_user").addClass(" offcanvas-on"); 
     
      $("#kt_quick_user_close").click(function(params) {
  ...
  methods: {
    ...
    date() {
      let d = new Date();
      let content = document.getElementById("fecha");

      content.innerHTML = d.getDate();
    },
    switchToTeam(team) {
      this.$inertia.put(
